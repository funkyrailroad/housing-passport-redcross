...
class BuildingDataModule(L.LightningDataModule):
    ...
    def setup(self, stage=None):
        if stage == "fit" or stage is None:
            ...
            self.trn_ds = BuildingDataset(trn_df, self.img_dir, self.trn_tfm)
            ...
            self.val_ds = BuildingDataset(val_df, self.img_dir, self.val_tfm)
            
            tst_df = pd.read_csv(self.data_dir / f"test.csv")
            self.tst_ds = BuildingDataset(tst_df, self.img_dir, self.tst_tfm)
