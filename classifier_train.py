...
from src.datamodule import BuildingDataModule
...
def main(name, img_dir, data_dir):
    ...
    ckpt_cb = ModelCheckpoint(
        ...
        save_last=True,
        verbose=True,
        filename="epoch{epoch}-step{step}-loss{val_loss:.3f}-f1{val_totalf1:.3f}", # PC
        # filename="epoch:{epoch}-step:{step}-loss:{val_loss:.3f}-f1:{val_totalf1:.3f}", # MAC
